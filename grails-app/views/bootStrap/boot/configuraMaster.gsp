			...
			<div class="modal-content" uib-modal-transclude="">
				<div class="col-md-10 col-xs-12 col-sm-12 pull-right">
					...
					<p class="text-justify" style="text-align: justify;">
						Per accedere al vaso master sono necessari alcuni parametri. Con
						un codice di attivazione tutti i parametri tecnici sono
						pre-configurati. E' possibile acquisire un codice di
						configurazione dal <a href="https://registrazione.ar4k.eu"
							target="_new">portale del progetto Ar4k</a>.
					</p>
					<p>
				...
				<div class="col-md-10 col-xs-12 col-sm-12 pull-right">
					<p class="text-justify" style="text-align: justify;">Il sistema
						...
						provando una connessione http ad un indirizzo pubblico. La prova
						ha dato esito positivo e la configurazione del proxy per
						permettere l'accesso all'esterno non dovrebbe essere necessaria.
						Tuttavia, in particolari scenari di rete è necessario configurare
						l'accesso all'esterno tramite proxy.
					<p>
					<p>
