				...
				<div class="panel-heading">
					<h3 class="text-right">
						...
						<button style="margin: 0.1em;"
							...
							uib-tooltip="visualizza la documentazione sui servizi.">
				...
				<div class="panel-body">
					<div class="container-fluid">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 div4-padding">
								<h4>Indirizzo</h4>
							</div>
							<div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 div4-padding">
								<h4>Porta</h4>
							</div>
							<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 div4-padding">
								<h4>Servizio</h4>
							</div>
							<div
								class="col-xs-12 col-sm-8 col-md-2 col-lg-2 text-right div4-padding">
								<h4>Azioni</h4>
							</div>
						</div>
						<div ng-repeat="processo in processi | filter:queryRicerca"
							...
							<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 div4-padding">{{processo.stato}}</div>
							<div
								...
								<button style="margin: 0.1em;"
									...
									uib-tooltip="configura il monitoraggio del servizio">
									<i class="fa fa-desktop"></i>
								</button>
								<button style="margin: 0.1em;"
									class="btn btn-circle btn-info btn-xs" type="button"
									ng-click="" tooltip-placement="top"
									uib-tooltip="gestisci i link e i qr per questo servizio">
									<i class="fa fa-qrcode"></i>
								</button>
								<button style="margin: 0.1em;" class="btn btn-circle btn-xs"
									type="button" ng-click="" tooltip-placement="top"
									uib-tooltip="copia link servizio">
					...
					<div class="div4-padding">
						<div class="panel panel-green">
							<div class="panel-heading text-center">Servizi Cloud</div>
							<div class="panel-body">
