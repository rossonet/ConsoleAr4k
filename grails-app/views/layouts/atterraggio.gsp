	...
	<div id="outer-container">
		...
		<section id="left-sidebar">
			...
			<div id="mobile-menu-icon" class="visible-xs"
				...
				<span class="text-center fa fa-th fa-2x"></span>
			</div>
			...
			<ul id="main-menu">
				...
				<sec:ifLoggedIn>
					...
					<li id="menu-item-esci" class="menu-item scroll"><form
							name="submitForm" method="POST" class="text-center"
							style="padding-top: 1em;"
							action="${createLink(controller: 'logout')}">
							<a href="javascript:document.submitForm.submit()">Esci da
								AR4K</a>
						</form></li>
				...
				<article id="entra" class="section-wrapper clearfix"
					...
					<div class="content-wrapper clearfix">
						...
						<div
							...
							<p class="text-right">Utilizzando il nostro portale
								...
								<div class="col-md-6 col-xs-12 col-sm-12">
									...
									<div class="form-group">
										<label><input type="checkbox"
											...
											checked="checked" />Ricordami su questo dispositivo</label>
									</div>
									<div class="form-group">
										<img
					...
					<div class="col-sm-10 col-md-9 pull-right">
						...
						<section class="feature-text">
							...
							<p class="text-justify" style="text-align: justify;">AR4K è un nuovo orientamento nei
								...
								modifica della struttura informatica dell'azienda,
								basterà aggiungere e incorporare nell'architettura tecnologica
					...
					<div class="col-sm-10 col-md-9 pull-right">
						...
						<section class="feature-text">
							...
							<p class="text-justify" style="text-align: justify;">AR4K si basa sull'idea che nel
								...
								tipo di connessione che permette all'azienda di conoscere in modo
		...
		<section id="footer">
			...
			<ul class="social-icons">
				<li><a href="https://www.facebook.com/blog.rossonet">
						<img
							src="${resource(dir: 'atterraggio', file: 'images/social_icons/facebook.png')}"
							alt="Facebook">
					</a></li>
				<li><a href="https://github.com/rossonet">
						<img
							src="${resource(dir: 'atterraggio', file: 'images/social_icons/github.png')}"
							alt="GitHub">
					</a></li>
				<li><a href="https://www.linkedin.com/company/rossonet">
						<img
							src="${resource(dir: 'atterraggio', file: 'images/social_icons/linkedin.png')}"
							alt="LinkedIn">
					</a></li>
				<li><a href="https://twitter.com/ar4k_bot">
						<img
			...
			<div class="footer-text-line">
				<a href="http://www.gnu.org/licenses/agpl-3.0.html"
					target="_licenza">&copy;</a> 2015 <a href="http://www.rossonet.org"
